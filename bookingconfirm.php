...
<?php
    ...
    echo "Start Date: " . $rent_start_date . "<br>";
    echo "End Date: " . $rent_end_date . "<br>";
    echo "Date Difference: " . $err_date . "<br>";
    ...
    $sql1 = "INSERT INTO rentedcars(customer_username, car_id, driver_id, booking_date, rent_start_date, rent_end_date, fare, charge_type, return_status, no_of_days, total_amount) 
    VALUES('" . $customer_username . "','" . $car_id . "','" . $driver_id . "','" . date("Y-m-d") . "','" . $rent_start_date . "','" . $rent_end_date . "','" . $fare . "','" . $charge_type . "','" . $return_status . "', '" . $err_date . "', '" . ($err_date * $fare) . "')";
